        ...
        {loading ? <Skeleton /> : (
          <div className="space-y-4">
            ...
            <div className="bg-surface-card/80 backdrop-blur-md border border-border-subtle border-l-[3px] border-l-primary-500 rounded-xl p-5 hover:border-border-glow transition-colors duration-200">
              <p className="text-[10px] font-bold text-primary-500 uppercase tracking-[0.15em] mb-3">
                Şimdi Ne Yapmalıyım?
              </p>
              <div className="flex items-start gap-3">
                <Zap size={16} style={{ color: '#b91c1c', flexShrink: 0, marginTop: 2 }} />
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold text-ink-primary leading-snug">{action.text}</p>
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              <button
                onClick={() => openModal('morning').catch(() => toast.error('Brifing açılamadı'))}
              ...
              <button
                onClick={() => openModal('evening').catch(() => toast.error('Brifing açılamadı'))}
