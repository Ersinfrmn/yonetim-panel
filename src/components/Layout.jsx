...
import {
  ...
  LogOut, CalendarDays, ShieldOff, X, Library, Brain,
} from 'lucide-react'
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          ...
          style={{
            ...
            overflow:       'hidden',
            background:     expanded ? 'rgba(5,5,5,0.3)' : 'transparent',
        ...
        <main
          className="flex-1 overflow-y-auto pb-14 md:pb-0 pl-0 md:pl-16"
